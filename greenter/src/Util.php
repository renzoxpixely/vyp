...
//        $see->setCodeProvider(new XmlErrorCodeProvider());
        $see->setCertificate(file_get_contents(__DIR__ . '/../resources/'.$this->company_ruc.'.pem'));
        $see->setCredentials($this->company_ruc.$this->company_user, $this->company_pass);
    ...
    public function writeFile($filename, $content)
    {
        ...
        file_put_contents(__DIR__.'/../files/'.$this->company_folder.'/'.$filename, $content);
    }
