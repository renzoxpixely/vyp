   ...
   function CrearXMLFactura($nombrexml, $emisor, $cliente, $comprobante, $detalle)
   {
      ...
      <Invoice xmlns="urn:oasis:names:specification:ubl:schema:xsd:Invoice-2" xmlns:cac="urn:oasis:names:specification:ubl:schema:xsd:CommonAggregateComponents-2" xmlns:cbc="urn:oasis:names:specification:ubl:schema:xsd:CommonBasicComponents-2" xmlns:ds="http://www.w3.org/2000/09/xmldsig#" xmlns:ext="urn:oasis:names:specification:ubl:schema:xsd:CommonExtensionComponents-2">
         ...
         <cac:Signature>
            ...
            <cbc:Note><![CDATA[' . htmlspecialchars($emisor['nombre_comercial']) . ']]></cbc:Note>
            <cac:SignatoryParty>
               <cac:PartyIdentification>
                  <cbc:ID>' . $emisor['ruc'] . '</cbc:ID>
               </cac:PartyIdentification>
               <cac:PartyName>
                  <cbc:Name><![CDATA[' . htmlspecialchars($emisor['razon_social']) . ']]></cbc:Name>
               </cac:PartyName>
            </cac:SignatoryParty>
         ...
         <cac:AccountingSupplierParty>
            <cac:Party>
               ...
               <cac:PartyName>
                  <cbc:Name><![CDATA[' . htmlspecialchars($emisor['nombre_comercial']) . ']]></cbc:Name>
               </cac:PartyName>
               <cac:PartyLegalEntity>
                  <cbc:RegistrationName><![CDATA[' . htmlspecialchars($emisor['razon_social']) . ']]></cbc:RegistrationName>
                  <cac:RegistrationAddress>
                     <cbc:ID>' . $emisor['ubigeo'] . '</cbc:ID>
                     <cbc:AddressTypeCode>0000</cbc:AddressTypeCode>
                     <cbc:CitySubdivisionName>NONE</cbc:CitySubdivisionName>
                     <cbc:CityName>' . htmlspecialchars($emisor['provincia']) . '</cbc:CityName>
                     <cbc:CountrySubentity>' . htmlspecialchars($emisor['departamento']) . '</cbc:CountrySubentity>
                     <cbc:District>' . htmlspecialchars($emisor['distrito']) . '</cbc:District>
                     <cac:AddressLine>
                        <cbc:Line><![CDATA[' . htmlspecialchars($emisor['direccion']) . ']]></cbc:Line>
                     </cac:AddressLine>
                     <cac:Country>
      ...
      if ($cliente['tipodoc'] == 6) {
         $xml .= '<cac:AccountingCustomerParty>
            <cac:Party>
               ...
               <cac:PartyLegalEntity>
                  <cbc:RegistrationName><![CDATA[' . htmlspecialchars($cliente['razon_social']) . ']]></cbc:RegistrationName>
                  <cac:RegistrationAddress>
                     <cac:AddressLine>
                        <cbc:Line><![CDATA[' . htmlspecialchars($cliente['direccion']) . ']]></cbc:Line>
                     </cac:AddressLine>
                     <cac:Country>
      ...
      foreach ($detalle as $k => $v) {
         ...
         $xml .= '<cac:InvoiceLine>
               ...
               <cac:Item>
                  <cbc:Description><![CDATA[' . htmlspecialchars($v['descripcion']) . ']]></cbc:Description>
   ...
   function CrearXMLNotaCredito($nombrexml, $emisor, $cliente, $comprobante, $detalle)
   {
      ...
      <CreditNote xmlns="urn:oasis:names:specification:ubl:schema:xsd:CreditNote-2" xmlns:cac="urn:oasis:names:specification:ubl:schema:xsd:CommonAggregateComponents-2" xmlns:cbc="urn:oasis:names:specification:ubl:schema:xsd:CommonBasicComponents-2" xmlns:ds="http://www.w3.org/2000/09/xmldsig#" xmlns:ext="urn:oasis:names:specification:ubl:schema:xsd:CommonExtensionComponents-2">
         ...
         <cac:DiscrepancyResponse>
            ...
            <cbc:Description>' . htmlspecialchars($comprobante['descripcion']) . '</cbc:Description>
         </cac:DiscrepancyResponse>
