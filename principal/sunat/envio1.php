          ...
          <table class="rodrigo-table-data" border="1px" id="sunat-table">
            <thead>
              <tr>
                ...
                <th style="color:blue; text-align:center;"><span id="cpe-sent">0</span> enviados</th>
                <th style="color:red; text-align:center;"><span id="cpe-pending">0</span> pendientes</th>
              </tr>
            </thead>
          </table>
          <br>
          <table class="rodrigo-table-data" border="1px" style="border-collapse:collapse;" id="sunat-table">
            <thead>
              <tr>
