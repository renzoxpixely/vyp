...
<body>
    <div class="tabla1">
        ...
        <div class="title1">
            <span class="titulos">SISTEMA DE VENTAS - Reposicion de Minimos</span>
        </div>
        <div class="mask1111">
            <div class="mask2222">
                <div class="mask3333">
                    <iframe src="reposicion_min1.php" name="principal" width="978" height="660" scrolling="Automatic" frameborder="0" id="principal" allowtransparency="0"></iframe>
                </div>
            </div>
        </div>
    </div>
