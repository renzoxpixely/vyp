...
<?php
$sql="SELECT U.usecod,U.nomusu,U.logusu,U.abrev,U.fecha_reg,U.estado,X.nomloc, X.nombre FROM usuario U INNER JOIN xcompa X ON U.codloc = X.codloc where U.codgrup = '$codgrup' and U.eliminado='0'";
