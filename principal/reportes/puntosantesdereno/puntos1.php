...
´      <td width="944">
    ...
    <iframe src="puntos2.php?search=<?php echo $search?>&&val=<?php echo $val?>" name="marco" id="marco" width="954" height="450" scrolling="Automatic" frameborder="0" allowtransparency="0">
  </iframe>
</body>
</html>
