                    ...
                    <form id="form1" name="form1" method = "post" action="">
                            ...
                            <tr>
                                ...
                                <td width="180">
                                    <select name="TipBusk" id="TipBusk">
                                        ...
                                        <option <?php if ($TipBusk == 2) { ?>selected<?php } ?> value="2">Lo que se ha vendido y se agoto</option>
                                        <option <?php if ($TipBusk == 3) { ?>selected<?php } ?> value="3">Pronostico de Demanda</option>
                                    </select>
                                </td>
                                <td width="24">
                                    <?php
                        ...
                        <table width="928" border="0">
                            <tr>
                                ...
                                <td width="199">&nbsp;</td>
                                <td width="250"><input name="val" type="hidden" id="val" value="1" />
                                <?php 
                                    if ($local != '' && $local != 'all') {
                                    ?>
                                    <input type="button" name="prepedido" value="Prepedido" onclick="generarPrepedido()" class="buscar"/>
                                <?php
                                    }
                                ?>
