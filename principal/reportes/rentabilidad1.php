...
<link rel='STYLESHEET' type='text/css' href='../../css/calendar.css'>
 <table width="954" border="0">
        ...
        <form id="form1" name="form1" method = "post" action="">
          ...
          <table width="929" border="0">
            <tr>
              ...
              <td width="97"><input type="text" name="date1" id="date1" size="12" value="<?php if ($date1 == ""){ echo $date;} else{ echo $date1;}?>" /></td>
              <td width="75"><div align="right">LOCAL</div></td>
              <td width="169">
  ...
  {
  ?>
  <iframe src="rentabilidad2.php?val=<?php echo $val?>&date1=<?php echo $date1?>&date2=<?php echo $date2?>&local=<?php echo $local?>&det=<?php echo $det?>&ltdgen=<?php echo $ltdgen?>&amp;&amp;marca=<?php echo $marca?>" name="marco" id="marco" width="954" height="430" scrolling="Automatic" frameborder="0" allowtransparency="0">
  </iframe>
  <?php }
  ?>
</body>
