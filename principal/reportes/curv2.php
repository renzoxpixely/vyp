  ...
  <tr>
    <td><table width="926" border="0" align="center">
      <tr>
        ...
        <td width="70"><div align="CENTER"><strong>STOCK</strong></div></td>
        <td width="50"><div align="CENTER" class='Estilo1'><strong>FALTANTES</strong></div></td>
...
if ($tip == 1)
{
		...
		$factor        = $row1['factor'];
			...
			$sumcantidadAux = $sumcantidad;
                ...
                if ($factor > 1)
                {
                    ...
                    $sumcantidadd    = $div1.' F '.$tot1;
                }
                if ($Tabla <> "0")
                {
                    $sql1="SELECT desprod,codmar,$Tabla,factor, s000 FROM producto where codpro = '$codpro'";
                }
                else
                {
                    $sql1="SELECT desprod,codmar,stopro,factor, s000 FROM producto where codpro = '$codpro'";
                }
	...
	?>
	  <tr>
            ...
            <td width="300"><?php echo $desprod?></td>
            <td width="169"><?php echo $destab?></td>
            <td width="60"><div align="right"><?php echo $sum?></div></td>
            <td width="87"><div align="right"><?php echo $sumcantidadd?></div></td>
            <td width="70"><div align="center"><?php echo $StockActuall;?></div></td>
            <td width="58"><div align="right"><?php echo "<p class='Estilo1'>$StockK</p>";?></div></td>
