                    ...
                    <tr>
                        <td><table width="926" border="0" align="center">
                                <tr>
									...
									<?php if ($marca == 'all') { ?>
										<td width="120"><div align="left"><strong>MARCA</strong></div></td>
									<?php }  ?>
                                    
                                    <td width="155"><div align="left"><strong>PRODUCTO</strong></div></td>
                                    <td width="160"><div align="right"><strong>CAJAS Y UNIDADES</strong></div></td>
                                    <td width="95"><div align="right"><strong>MONTO VENTA</strong></div></td>
                                    <td width="95"><div align="right"><strong>COSTO VENTA</strong></div></td>
                                    <td width="95"><div align="right"><strong>RENTABILIDAD</strong></div></td>
                                    <td width="118"><div align="right"><strong>% RENTABILIDAD</strong></div></td>
                    ...
                    <tr>
                        ...
                        if (mysqli_num_rows($result1)) {
                            while ($row1 = mysqli_fetch_array($result1)) {
                                ...
                                if (mysqli_num_rows($result1)) 
								{
                                    ...
                                    $saldoactual=$canprod + ($canprod1* $factor );
                                     ...
                                     if($factor <> 1){
                                        $c= $canprod1 * $factor;
                                        $f= $canprod ;
                                        $suma = $canprod1 + $canprod;
                                         $sumpcosto = ($costpr*$suma);
                                     }else{
                                          $sumpcosto = ($costpr*$canprodsinfac);
                                     }
                                ...
                                //$rentabilidad 	= $rentabilidad + ($canpro*$costpr);
                                ...
                                <tr height="25"  <?php if($datDSDe2){?> bgcolor="#ff0000"<?php } else {?>onmouseover="this.style.backgroundColor='#FFFF99';this.style.cursor='hand';" onmouseout="this.style.backgroundColor='#ffffff';"<?php }?>>
									...
									<?php }  ?>
                                        ...
                                        <td width="166"><div align="right"><?php if ($factor <> 1){echo $div1."  <strong>C</strong>"  ." - ". $UNI1." <strong>U</strong> "; }else {  echo $canprodsinfac ."  <strong>C</strong>" ;}?></div></td>									
                                        
                                        <td width="103"><div align="right"><?php echo $numero_formato_frances = number_format($sumpripro, 2, '.', ' '); ?></div></td>
                                        
                                        
										<td width="100"><div align="right"><?php echo $numero_formato_frances = number_format($sumpcosto, 2, '.', ' '); ?></div></td>
										<td width="97"><div align="right"><?php echo $numero_formato_frances = number_format($rentabilidad, 2, '.', ' '); ?> </div></td>
										<td width="131"><div align="right"><?php echo $numero_formato_frances = number_format($porcentaje, 2, '.', ' '); ?> %</div></td>
                                </tr>
                            <?php
                            } /////CIERRO EL WHILE
                            ?>
