  ...
  <tr>
    <td>
    	...
    	<table width="926" border="0" align="center">
            ...
            <td width="70"><div align="left"><strong>PRODUCTO</strong></div></td>
            <td width="55"><div align="left"><strong>MARCA</strong></div></td>
...
<!--      <tr>
       ...
       <tr>
        ...
        <td  width="<?php if ($doc == 2){?>160<?php }elseif ($doc == 1){?>134<?php }elseif ($doc == 3){?>21000<?php }else{?>0<?php }?>"><div align="center"><?php if ($doc == 2){echo "<strong>FECHA VENCIMIENTO</strong>";}elseif ($doc == 1){echo "<strong>FECHA VENCIMIENTO</strong>";}elseif ($doc == 3){echo "<strong> FECHA VENCIMIENTO </strong>";}?></div></td>
