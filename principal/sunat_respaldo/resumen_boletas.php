...
<div class="title1">
	<span class="titulos">SUNAT - GENERACION DE COMUNICACION DE BAJA</span>
</div>
<div class="mask1111">
	<div class="mask2222">
		<div class="mask3333">
			<iframe src="resumen_boletas1.php" name="principal" width="978" height="600" scrolling="Automatic" frameborder="0" id="principal" allowtransparency="0">
			</iframe>
  	  </div>
	</div>
   </div>
