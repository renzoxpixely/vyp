		...
		<input type="hidden" name="factor" value="<?php echo $factor;?>"/>
            ...
            <td width="38" valign="bottom">
                <div align="center">
                    ...
                    <?php } else { ?>
                    <a href="compras3.php?cod=<?php echo $codpro?>&valform=1&ok=<?php echo $ok?>&busca_prov=<?php echo $busca_prov;?>">
                        <img src="../../../images/edit_16.png" width="16" height="16" border="0"/>
                        </a>
                        <a href="compras4.php?cod=<?php echo $codtemp?>&ok=<?php echo $ok?>&busca_prov=<?php echo $busca_prov;?>" target="comp_principal">
