...
<body onload="<?php if ($msg == 1){?>ss();<?php } if ($msg == 2){?>sf();<?php } if ($pop == 1){?> popUpWindow()<?php }?>">
	<div class="tabla1">
		...
		<div class="mask1111">
			<div class="mask2222">
				<div class="mask3333">
					<iframe src="compras1.php?msg=<?php echo $msg?>&DatosProveedor=<?php echo $DatosProveedor;?>&ok=<?php echo $ok?>" name="comp_principal" width="1600px" height="1000" scrolling="Automatic" frameborder="0" id="comp_principal" allowtransparency="0">
					</iframe>
				</div>
			</div>
		</div>
