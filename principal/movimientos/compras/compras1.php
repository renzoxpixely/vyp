				...
				<table width="1250" border="0">
					...
					<table width="1250" border="0">
						<tr>
							...
							<td width="106"><input name="date2" type="text" id="date2" onfocus="blur()" size="15" value="<?php echo fecha($fecven)?>"/>
							<input name="ok" type="hidden" id="ok" value="<?php echo $ok?>" /></td>
							<td width="65">INCL. IGV </td>
							<td width="35"><input value="1" <?php if ($ckigv == 1){?>checked<?php }?> type="checkbox" name="ckigv" id="ckigv" onclick="ValidarIGV();"/></td>
					...
					<div align="left"><img src="../../../images/line2.png" width="1350" height="4" /></div>
						...
						<tr>
							<td width="955">
								<?php
									...
									{
								?>
										<iframe src="compras3.php?ok=<?php echo $ok?>&ckigv=<?php echo $ckigv;?>&busca_prov=<?php echo $busca_prov;?>" name="iFrame2" width="954" height="394" scrolling="Automatic" frameborder="0" id="iFrame2" allowtransparency="0"> </iframe>
								<?php 
									}
									else
									{
								?>
										<iframe src="compras2.php?ok=<?php echo $ok?>&ckigv=<?php echo $ckigv;?>&busca_prov=<?php echo $busca_prov;?>" name="iFrame3" width="1260px" height="204" scrolling="Automatic" frameborder="0" id="iFrame3" allowtransparency="0"> </iframe>
										<iframe src="compras3.php?ok=<?php echo $ok?>&ckigv=<?php echo $ckigv;?>&busca_prov=<?php echo $busca_prov;?>" name="iFrame2" width="1260px" height="190" scrolling="Automatic" frameborder="0" id="iFrame2" allowtransparency="0"> </iframe>
								<?php
									}
								?>
							</td>
