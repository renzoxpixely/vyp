...
<div class="title1">
<span class="titulos">SISTEMA DE VENTAS - Movimiento de Mercaderias - Ingresos Varias
</span></div>
<div class="mask1111">
	<div class="mask2222">
		<div class="mask3333">
			<iframe src="ingresos_varios1.php" name="comp_principal" width="978" height="615" scrolling="Automatic" frameborder="0" id="comp_principal" allowtransparency="0">
			</iframe>
  	  </div>
	</div>
   </div>
