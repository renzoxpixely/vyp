...
<table class="celda2" width="939">
  ...
  <table class="celda2" width="939">
	...
	while ($row = mysqli_fetch_array($result)){
			...
			$sql1="SELECT desprod,codmar,factor,pcostouni,stopro,$tabla, lote FROM producto where codpro = '$codpro'";
			$result1 = mysqli_query($conexion,$sql1);
			if (mysqli_num_rows($result1)){
			while ($row1 = mysqli_fetch_array($result1)){
	...
	<td width="27">
      ...
      <td width="61" valign="bottom">
	    <div align="center">
          ...
          <?php } else { ?>
	      <a href="ingresos_varios3.php?cod=<?php echo $codpro?>&valform=1"><img src="../../../images/edit_16.png" width="16" height="16" border="0"/></a>
