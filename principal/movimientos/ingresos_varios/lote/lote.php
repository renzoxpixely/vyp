...
function grabar()
{
  ...
  if (f.years.value == "")
  { alert("Ingrese el Año"); f.years.focus(); return; }
  ...
  if (longitud < 3)
  { alert("Ingrese un Año valido"); f.years.focus(); return; }
  var fecha  = new Date();
  ...
  if (ano > cadena)
  { 
    alert("Ingrese un Año posterior al Año Actual"); f.years.focus(); return; 
  }
  else
  {
    if (ano == cadena)
