...
while ($row = mysqli_fetch_array($result)){
		...
		$date   = date('Y-m-d');
		$sqlInsert = "INSERT INTO kardex (codpro, nrodoc, tipmov, tipdoc, invnum, qtypro, fecha, sucursal, eliminado, factor, sactual) VALUES('$codpro', '$numdoc', '1', '1', '$cod', '$cant_unid', '$date', '$sucursal', '3', '$factor', '$sactual')";
		error_log($sqlInsert);
