                    ...
                    <div align="right">
                      ...
                      <input name="modif" type="button" id="modif" value="Modificar" class="modificar" disabled="disabled" onclick="modificar()"/>
											...
											<?php if ($val_habil == 1){?>
												...
												<?php } else {
													if ($ingresado == 1) { ?>
																<input name="del1" type="button" id="del1" value="Anular" class="eliminar" <?php if ($find <>1){?>disabled="disabled" <?php }?> onclick="alert('Transferencia ya ingresada, no se puede anular');"/>											
														<?php
													} else { ?>
