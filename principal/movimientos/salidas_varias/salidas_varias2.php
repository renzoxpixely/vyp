  ...
  <table class="celda2" width="910">
	...
	?>
	 <tr onmouseover="this.style.backgroundColor='#FFFF99';this.style.cursor='hand';" onmouseout="this.style.backgroundColor='#ffffff';">
      ...
      <td width="17"><div align="center"><?php if ($control == 0){ if ($cant_loc > 0) {?> <a href="transferencia2_sal_reg.php?cod=<?php echo $codpro?>" target="comp_principal"><img src="../../../images/add.gif" width="14" height="15" border="0"/></a><?php }}else{?><img src="../../../images/icon-16-checkin.png" width="16" height="16" border="0"/><?php }?></div></td>
    </tr>
	<?php }
	?>
  </table>
