...
$numCopias   = isset($_REQUEST['numCopias'])? $_REQUEST['numCopias'] : 2;
...
<body onload="imprimir();">
    ...
    $sqlV="SELECT anotacion, invnum,nrovent,invfec,invfec,cuscod,usecod,codven,forpag,fecven,sucursal,correlativo,nomcliente,pagacon,vuelto,bruto,hora,invtot,igv,valven,tipdoc,tipteclaimpresa "
    ...
    $SumGrabado = $invtot - ($igv + $SumInafectos);
            ...
            if (strlen($anotacion)>0)
            {
              echo pintaDatos("ANOTACI&Oacute;N: $anotacion");
            }
