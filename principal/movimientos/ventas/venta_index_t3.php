                            ...
                            <td width="<?php if ($resolucion == 1){?>60<?php }else{?>69<?php }?>">
                                <div align="right">
                                    ...
                                    if (($valform == 1) && ($cod == $codpro)) { ?> 
                                        ...
                                        <input name="t1" type="text" class="input_text1" id="t1" value="<?php if ($fraccion == 'T'){echo $canpro; } if ($fraccion == 'F') { $canpro = "c".$canpro; echo $canpro;}?>" size="20" onKeyUp ="precio1();" onkeypress="return letrac(event)"/>
                                    <?php
                                    } else { ?>
                                        <div class="<?php echo $text?>">
                                        <?php
