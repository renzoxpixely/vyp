...
function letraent(evt)
{
	...
	if (key == 13)
	{
	  ...
	  ventana=confirm("La cantidad Ingresada excede al Stock Actual del Producto Desea Grabar esta informacion?");
		 ...
		 {
		  f.method = "post";
		  f.action ="venta_index_t2_reg.php";
		  f.submit();
		 }
		 else
		 {
...
tecla=e.keyCode;
  ...
  if(tecla==113)
  {
  	 window.open('f2/f2.php','PopupName','toolbar=0,location=0,status=0,menubar=0,scrollbars=1,resizable=0,top=160,left=120,width=605,height=350');
  }
  ////F4///
  if(tecla==115)
  {
    ...
    if((tecla==120))
    {
        ...
        else
        {
                ...
                if (claveVendedor !== null)
                {
                    $.ajax({
                        ...
                        success: function(datos) 
                        {
                            ...
                            {
                                //ENVIO NORMALMENTE
                                //--------------------------window.open('preimprimir_temp.php?CodClaveVendedor=c' + claveVendedor,'PopupName','toolbar=0,location=0,status=0,menubar=0,scrollbars=1,resizable=0,top=60,left=120,width=885,height=630');
                                window.open('preimprimir_temp.php?CodClaveVendedor=c'+ claveVendedor+'&tecKey='+tecKey,'PopupName','toolbar=0,location=0,status=0,menubar=0,scrollbars=1,resizable=0,top=160,left=120,width=885,height=630');
                            }
                            else
                            {
                                alert("No existe el Usuario");return;
            ...
            {
            ?>
                //----------------------------window.open('preimprimir_temp.php','PopupName','toolbar=0,location=0,status=0,menubar=0,scrollbars=1,resizable=0,top=60,left=120,width=885,height=630');
                window.open('preimprimir_temp.php?tecKey='+tecKey,'PopupName','toolbar=0,location=0,status=0,menubar=0,scrollbars=1,resizable=0,top=160,left=120,width=885,height=630');
            <?php 
            }
            ?>
        }
