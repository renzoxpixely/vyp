...
<table width="869" border="0" bordercolor="#666666">
  <tr>
	...
	<b><span class="Letras"><?php if ($contit == 0){echo $descm;}?></span></b></a></div>
                ...
                <td><?php $ic = 1;
					...
					while ($row = mysqli_fetch_array($result)){
							...
							if ($ic == $col)
							{
								...
								if ($cam1 == 'montext'){ echo '<span class="Letras">Son :'; 
								$sumtext = strtoupper(letras2($monto_total)); 
								$sumtext = strlen($sumtext) + 18;
								echo $text_letra = strtoupper(letras2($monto_total)); echo ' Nuevos Soles</span>';}					
