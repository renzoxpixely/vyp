...
<body onload="imprimir()">
    ...
    ?>
        <table width="100%" border="4" cellpadding="0" cellspacing="0" bordercolor="#000000">
            <tr>
                <td style="font-size: 22px;"><center><b><?php echo $descli;?></b></center></td>
                <td style="font-size: 26px;"><center><b><?php echo $TextDoc;?> - <?php echo $serie.'-'.zero_fill($correlativo,8);?></b></center></td>
            </tr>
        </table>
        <br>
        <br>
