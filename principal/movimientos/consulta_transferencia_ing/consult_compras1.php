                ...
                <td width="580"><label>
                    <div align="right">
                      ...
                      <input name="modif" type="button" id="modif" value="Modificar" class="modificar" disabled="disabled" onclick="modificar()"/>
											...
											<?php if ($val_habil == 1){?>
					  <input name="del" type="button" id="del" value="Activar" class="eliminar" <?php if ($find <>1){?>disabled="disabled" <?php }?> onclick="habilitaring()"/>
					  <?php } else {?>
						<?php if ($est_habil_stock==1) {
							?>
							<input name="del1" type="button" id="del1" value="Anular" class="eliminar" <?php if ($find <>1){?>disabled="disabled" <?php }?> onclick="eliminaring()"/>
							<?php
						} else {
							?>
